    ...
    add: function(filter)
    {
      if (filter instanceof ElemHideException)
      {
        ...
        if (usingGetSelectorsForDomain)
        {
          ...
          {
            for (var _loopIndex33 = 0; _loopIndex33 < unconditionalFilters.length; ++_loopIndex33)
            {
              var f = unconditionalFilters[_loopIndex33];
...
require.scopes["events"] = (function()
{
  ...
  exports.EventEmitter.prototype = {
    ...
    emit: function(name)
    {
      ...
      for (var _loopIndex34 = 0; _loopIndex34 < listeners.length; ++_loopIndex34)
      {
        var listener = listeners[_loopIndex34];
...
require.scopes["filterClasses"] = (function()
{
  ...
  Filter.normalize = function(text)
  {
    ...
    {
      var _tempVar35 = /^(.*?)(#\@?#?)(.*)$/.exec(text);
      var domain = _tempVar35[1];
      var separator = _tempVar35[2];
      var selector = _tempVar35[3];
  ...
  RegExpFilter.fromText = function(text)
  {
    ...
    if (match)
    {
      ...
      for (var _loopIndex36 = 0; _loopIndex36 < options.length; ++_loopIndex36)
      {
        var option = options[_loopIndex36];
        var value = null;
  ...
  ElemHideBase.fromText = function(text, domain, isException, tagName, attrRules, selector)
  {
    if (!selector)
    {
      ...
      if (attrRules)
      {
        ...
        for (var _loopIndex37 = 0; _loopIndex37 < attrRules.length; ++_loopIndex37)
        {
          var rule = attrRules[_loopIndex37];
...
require.scopes["filterListener"] = (function()
{
  ...
  var RegExpFilter = _tempVar38.RegExpFilter;
  var ElemHideBase = _tempVar38.ElemHideBase;
  var CSSPropertyFilter = _tempVar38.CSSPropertyFilter;
  var Prefs = require("prefs").Prefs;
  var isDirty = 0;
  var FilterListener = {
  ...
  function onLoad()
  {
    ...
    ElemHide.clear();
    CSSRules.clear();
    for (var _loopIndex39 = 0; _loopIndex39 < FilterStorage.subscriptions.length; ++_loopIndex39)
    {
      var subscription = FilterStorage.subscriptions[_loopIndex39];
      if (!subscription.disabled)
      {
        addFilters(subscription.filters);
      }
...
require.scopes["filterStorage"] = (function()
{
  ...
  var Prefs = require("prefs").Prefs;
  var _tempVar40 = require("filterClasses");
  var Filter = _tempVar40.Filter;
  var ActiveFilter = _tempVar40.ActiveFilter;
  var _tempVar41 = require("subscriptionClasses");
  var Subscription = _tempVar41.Subscription;
  var SpecialSubscription = _tempVar41.SpecialSubscription;
  var ExternalSubscription = _tempVar41.ExternalSubscription;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var Utils = require("utils").Utils;
  var formatVersion = 4;
  var FilterStorage = exports.FilterStorage = {
    ...
    getGroupForFilter: function(filter)
    {
      ...
      for (var _loopIndex42 = 0; _loopIndex42 < FilterStorage.subscriptions.length; ++_loopIndex42)
      {
        var subscription = FilterStorage.subscriptions[_loopIndex42];
    ...
    resetHitCounts: function(filters)
    {
      ...
      for (var _loopIndex43 = 0; _loopIndex43 < filters.length; ++_loopIndex43)
      {
        var filter = filters[_loopIndex43];
        filter.hitCount = 0;
        filter.lastHit = 0;
      }
    },
      ...
      var readFile = function(sourceFile, backupIndex)
      {
        ...
        IO.readFromFile(sourceFile, parser, function(e)
        {
          ...
          if (e && !explicitFile)
          {
            ...
            if (sourceFile)
            {
              var _tempVar44 = /^(.*)(\.\w+)$/.exec(sourceFile.leafName) || [null, sourceFile.leafName, ""];
    ...
    {
      var _generatorResult45 = [];
      _generatorResult45.push("# Adblock Plus preferences");
      _generatorResult45.push("version=" + formatVersion);
      ...
      var checkBackupRequired = function(callbackNotRequired, callbackRequired)
      {
        ...
        else
        {
          IO.statFile(targetFile, function(e, statData)
          {
            ...
            {
              var _tempVar46 = /^(.*)(\.\w+)$/.exec(targetFile.leafName) || [null, targetFile.leafName, ""];
              var part1 = _tempVar46[1];
              var part2 = _tempVar46[2];
    ...
    {
      var result = [];
      var _tempVar47 = /^(.*)(\.\w+)$/.exec(FilterStorage.sourceFile.leafName) || [null, FilterStorage.sourceFile.leafName, ""];
          ...
          if (this.curObj)
          {
            ...
            case "subscription patterns":
              if (this.subscriptions.length)
              {
                ...
                for (var _loopIndex50 = 0; _loopIndex50 < this.curObj.length; ++_loopIndex50)
                {
                  var text = this.curObj[_loopIndex50];
...
require.scopes["notification"] = (function()
{
  var exports = {};
  var Prefs = require("prefs").Prefs;
  var _tempVar52 = require("downloader");
  var Downloader = _tempVar52.Downloader;
  var Downloadable = _tempVar52.Downloadable;
  var MILLIS_IN_MINUTE = _tempVar52.MILLIS_IN_MINUTE;
  var MILLIS_IN_HOUR = _tempVar52.MILLIS_IN_HOUR;
  var MILLIS_IN_DAY = _tempVar52.MILLIS_IN_DAY;
  var Utils = require("utils").Utils;
  var _tempVar53 = require("matcher");
  var Matcher = _tempVar53.Matcher;
  var defaultMatcher = _tempVar53.defaultMatcher;
  ...
  var Notification = exports.Notification = {
    ...
    _getDownloadables: function()
    {
      ...
      _generatorResult45.push(downloadable);
      return _generatorResult45;
    },
    ...
    _onDownloadSuccess: function(downloadable, responseText, errorCallback, redirectCallback)
    {
      try
      {
        ...
        for (var _loopIndex55 = 0; _loopIndex55 < data.notifications.length; ++_loopIndex55)
        {
          var notification = data.notifications[_loopIndex55];
      ...
      var _tempVar56 = downloader.processExpirationInterval(EXPIRATION_INTERVAL);
      Prefs.notificationdata.softExpiration = _tempVar56[0];
      Prefs.notificationdata.hardExpiration = _tempVar56[1];
    ...
    _getNextToShow: function(url)
    {
      ...
      var _tempVar57 = require("info");
      var addonName = _tempVar57.addonName;
      var addonVersion = _tempVar57.addonVersion;
      var application = _tempVar57.application;
      var applicationVersion = _tempVar57.applicationVersion;
      var platform = _tempVar57.platform;
      var platformVersion = _tempVar57.platformVersion;
      var notificationToShow = null;
      for (var _loopIndex58 = 0; _loopIndex58 < notifications.length; ++_loopIndex58)
      {
        var notification = notifications[_loopIndex58];
        ...
        if (typeof url === "string" || notification.urlFilters instanceof Array)
        {
          if (Prefs.enabled && typeof url === "string" && notification.urlFilters instanceof Array)
          {
            ...
            for (var _loopIndex59 = 0; _loopIndex59 < notification.urlFilters.length; ++_loopIndex59)
            {
              var urlFilter = notification.urlFilters[_loopIndex59];
        ...
        {
          var match = false;
          for (var _loopIndex60 = 0; _loopIndex60 < notification.targets.length; ++_loopIndex60)
          {
            var target = notification.targets[_loopIndex60];
    ...
    showNext: function(url)
    {
      ...
      if (notification)
      {
        for (var _loopIndex61 = 0; _loopIndex61 < showListeners.length; ++_loopIndex61)
        {
          var showListener = showListeners[_loopIndex61];
    ...
    getLocalizedTexts: function(notification, locale)
    {
      ...
      var localizedTexts = [];
      for (var _loopIndex62 = 0; _loopIndex62 < textKeys.length; ++_loopIndex62)
      {
        var key = textKeys[_loopIndex62];
    ...
    triggerQuestionListeners: function(id, approved)
    {
      ...
      for (var _loopIndex63 = 0; _loopIndex63 < listeners.length; ++_loopIndex63)
      {
        var listener = listeners[_loopIndex63];
        listener(approved);
      }
    },
...
{
  var exports = {};
  var _tempVar64 = require("filterClasses");
  var ActiveFilter = _tempVar64.ActiveFilter;
  var BlockingFilter = _tempVar64.BlockingFilter;
  var WhitelistFilter = _tempVar64.WhitelistFilter;
  var ElemHideBase = _tempVar64.ElemHideBase;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var _tempVar65 = require("coreUtils");
  var desc = _tempVar65.desc;
  var extend = _tempVar65.extend;
  ...
  Subscription.prototype = {
    ...
    {
      for (var _loopIndex66 = 0; _loopIndex66 < this.filters.length; ++_loopIndex66)
      {
        var filter = this.filters[_loopIndex66];
  ...
  SpecialSubscription.prototype = extend(Subscription,
  {
    ...
    isDefaultFor: function(filter)
    {
      ...
      {
        for (var _loopIndex67 = 0; _loopIndex67 < this.defaults.length; ++_loopIndex67)
        {
          var type = this.defaults[_loopIndex67];
...
{
  var exports = {};
  var _tempVar68 = require("downloader");
  var Downloader = _tempVar68.Downloader;
  var Downloadable = _tempVar68.Downloadable;
  var MILLIS_IN_SECOND = _tempVar68.MILLIS_IN_SECOND;
  var MILLIS_IN_MINUTE = _tempVar68.MILLIS_IN_MINUTE;
  var MILLIS_IN_HOUR = _tempVar68.MILLIS_IN_HOUR;
  var MILLIS_IN_DAY = _tempVar68.MILLIS_IN_DAY;
  var _tempVar69 = require("filterClasses");
  var Filter = _tempVar69.Filter;
  var CommentFilter = _tempVar69.CommentFilter;
  var FilterStorage = require("filterStorage").FilterStorage;
  var FilterNotifier = require("filterNotifier").FilterNotifier;
  var Prefs = require("prefs").Prefs;
  var _tempVar70 = require("subscriptionClasses");
  var Subscription = _tempVar70.Subscription;
  var DownloadableSubscription = _tempVar70.DownloadableSubscription;
  var Utils = require("utils").Utils;
  var INITIAL_DELAY = 1 * MILLIS_IN_MINUTE;
  var CHECK_INTERVAL = 1 * MILLIS_IN_HOUR;
  ...
  var Synchronizer = exports.Synchronizer = {
    ...
    _getDownloadables: function()
    {
      ...
      for (var _loopIndex71 = 0; _loopIndex71 < FilterStorage.subscriptions.length; ++_loopIndex71)
      {
        var subscription = FilterStorage.subscriptions[_loopIndex71];
        if (subscription instanceof DownloadableSubscription)
        {
          _generatorResult45.push(this._getDownloadable(subscription, false));
        }
      }
      return _generatorResult45;
    },
    ...
    _onDownloadSuccess: function(downloadable, responseText, errorCallback, redirectCallback)
    {
      ...
      var _tempVar72 = downloader.processExpirationInterval(expirationInterval);
      var softExpiration = _tempVar72[0];
      var hardExpiration = _tempVar72[1];
      ...
      lines.shift();
      var filters = [];
      for (var _loopIndex73 = 0; _loopIndex73 < lines.length; ++_loopIndex73)
      {
        var line = lines[_loopIndex73];
...
require.scopes["devtools"] = (function()
{
  "use strict";
  var exports = {};
  var _tempVar74 = require("filterClasses");
  var RegExpFilter = _tempVar74.RegExpFilter;
  var WhitelistFilter = _tempVar74.WhitelistFilter;
  var ElemHideFilter = _tempVar74.ElemHideFilter;
  ...
  function getFilterInfo(filter)
  {
    ...
    for (var _loopIndex75 = 0; _loopIndex75 < filter.subscriptions.length; ++_loopIndex75)
    {
      var subscription = filter.subscriptions[_loopIndex75];
      if (!subscription.disabled)
      {
        if (subscription instanceof SpecialSubscription)
        {
  ...
  function logHiddenElements(page, selectors, docDomain)
  {
    var panel = getActivePanel(page);
    {
      for (var _loopIndex76 = 0; _loopIndex76 < FilterStorage.subscriptions.length; ++_loopIndex76)
      {
        var subscription = FilterStorage.subscriptions[_loopIndex76];
        if (subscription.disabled)
        {
          continue;
        }
        for (var _loopIndex77 = 0; _loopIndex77 < subscription.filters.length; ++_loopIndex77)
        {
          var filter = subscription.filters[_loopIndex77];
  ...
  exports.logWhitelistedDocument = function(page, url, typeMask, docDomain, filter)
  {
    ...
    if (panel)
    {
      for (var _loopIndex78 = 0; _loopIndex78 < nonRequestTypes.length; ++_loopIndex78)
      {
        var type = nonRequestTypes[_loopIndex78];
...
require.scopes["popupBlocker"] = (function()
{
  ...
  var defaultMatcher = require("matcher").defaultMatcher;
  var BlockingFilter = require("filterClasses").BlockingFilter;
  var _tempVar79 = require("url");
  var stringifyURL = _tempVar79.stringifyURL;
  var isThirdParty = _tempVar79.isThirdParty;
  var extractHostFromFrame = _tempVar79.extractHostFromFrame;
...
require.scopes["uninstall"] = (function()
{
  ...
  function setUninstallURL()
  {
    ...
    for (var _loopIndex80 = 0; _loopIndex80 < keys.length; ++_loopIndex80)
    {
      var key = keys[_loopIndex80];
